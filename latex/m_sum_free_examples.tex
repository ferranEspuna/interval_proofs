...
\section{Explicit constructions for \texorpdfstring{$m=4$}{m=4} and \texorpdfstring{$m=5$}{m=5}}
...
bound, while the \(m=4\) example adds a short third interval to that baseline.
